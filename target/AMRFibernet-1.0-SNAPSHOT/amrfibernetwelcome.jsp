...
<head>
 ...
 <title>Welcome | AMR Fibernet</title>
...
<body>
    ...
    <footer id="footer">
		...
		if (session != null) {
			if (session.getAttribute("user") != null) {
				...
				out.print("Hey," + name + "  Welcome to AMR Fibernet ");
			} else {
	...
	%>
                        ...
                        <h3>
                        <font color="orange">
                        We AMR Fiber net is the fastest growing Internet service providers on Hyderabad.
                        For best plans with affordable rates/price you can just check them on home page.
                        Easy payments can be done with high secured payment options.
                        </font>
